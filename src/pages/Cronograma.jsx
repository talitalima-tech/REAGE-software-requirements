...
const Cronograma = () => {
  const tarefasIniciais = [
    { id: 1, titulo: "Criação do Seminário de LP", data: "Quinta-Feira | 05/06", hora: "00:00", local: "Sala 01 | Unidade I", status: "Pendente", mes: "Junho" },
    { id: 2, titulo: "Revisão de Requisitos", data: "Segunda-Feira | 09/06", hora: "14h", local: "Biblioteca | Unidade I", status: "Pendente", mes: "Junho" },
    { id: 3, titulo: "Tirar Dúvidas Código POO - Monitoria", data: "Segunda-Feira | 23/06", hora: "20h", local: "Discord", status: "Pendente", mes: "Junho" },
    { id: 4, titulo: "Estruturas em Grafos - Grupo de Ana", data: "Quarta-Feira | 25/06", hora: "16:20", local: "Sala 02 | Unidade I", status: "Pendente", mes: "Junho" }
  ];
  ...
  const tarefasDoMes = tarefas.filter(t => t.mes === mesAtivo);
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6 min-h-[calc(100vh-160px)]">
      ...
      <div className="bg-reage-blue text-white p-6 rounded-2xl flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-lg font-bold">Olá, Amanda Laiane!</h2>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl shadow-sm divide-y divide-gray-100 overflow-hidden">
        {tarefasDoMes.length > 0 ? (
          ...
          <div className="p-8 text-center text-gray-400 text-xs italic">
            Nenhuma atividade cadastrada para {mesAtivo}.
          </div>
        )}
      </div>
